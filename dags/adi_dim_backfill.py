...
insert_args = [
    ...
    '--location=US',
    'query',
    '--destination_table moz-fx-data-derived-datasets:blpadi.adi_dimensional_by_date',
...
load_backfill_to_bq_temp_table.set_downstream(select_insert_into_final_table)
